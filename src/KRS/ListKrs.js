        ...
        [
          ...
          {text: 'YES', onPress: () => 
                {   console.log("tts "+JSON.stringify(e))
                    axios({method:'DELETE',url:URLAPI.BASE_URL+URLAPI.ENDPOINTS.KRS, headers:{//apiconfig.BASE_URL+apiconfig.ENDPOINTS.MAHASISWA
...
renderList = (item,index) => {
    return(
        <ListItem 
            ...
            <Body>
                <Text>{'Kode KRS : '+item.kode}</Text>
                <Text note>{'NIM : '+item.nim}</Text>
